...
feature_matrix = zeros(2*(length(p300_n400_channels)+length(n170_channels))*length(girls),6);     
...
for j=1:Number_Of_Subjects
    ...
    tic
    clearvars -except j feature_matrix botNv topNv p300_n400_channels n170_channels win_p300 win_n170 Number_Of_Subjects Skipped_Subjects girls 
    %Load subject
...
attributes = classify_ready(feature_matrix,l1,l2,'girls');
