...
feature_matrix = zeros((Number_Of_Channels)*length(boys),6);
Skipped_Subjects = 0;
...
for j=1:Number_Of_Subjects
    ...
    tic
    clearvars -except j feature_matrix botNv topNv Number_Of_Subjects Time_Window L1 Number_Of_Channels Channels boys Skipped_Subjects
...
attributes=classify_ready(feature_matrix,Number_Of_Channels/2,Number_Of_Channels/2,'boys');
